        ...
        builder: (context, value, child) {
          return Scaffold(
            appBar: UIHelper.commonAppBar(context,
                backButton: false,
                backgroundTransparent: value == 1 ? true : false),
            body: Container(
            ...
            bottomNavigationBar: BottomNavigationBar(
              ...
              items: [
                BottomNavigationBarItem(
                  icon: SvgPicture.asset(Resources.IC_EXPLORE,
                      color: Colors.grey),
                  title: Text(Resources.EXPLORE),
                ),
                BottomNavigationBarItem(
                  icon:
                      SvgPicture.asset(Resources.IC_SEARCH, color: Colors.grey),
                  title: Text(Resources.SEARCH),
                ),
                BottomNavigationBarItem(
                  icon:
                      SvgPicture.asset(Resources.IC_CHORDS, color: Colors.grey),
                  title: Text(Resources.CHORDS),
                ),
                BottomNavigationBarItem(
                  icon: SvgPicture.asset(Resources.IC_ACCOUNT,
                      color: Colors.grey),
